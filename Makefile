LIBO_BASENAMES = osc_match  osc_bundle_s osc_bundle_u osc_bundle_iterator_s osc_bundle_iterator_u osc_error osc_mem osc_message_s osc_message_u osc_message_iterator_s osc_message_iterator_u osc_atom_s osc_atom_u osc_array osc_atom_array_s osc_atom_array_u osc_vtable osc_dispatch osc_hashtab osc_linkedlist osc_util osc_rset osc_query osc_strfmt osc_typetag contrib/strptime osc_timetag osc_serial osc_expr_ast_expr osc_expr_ast_funcall osc_expr_ast_value osc_expr_ast_list osc_expr_ast_function osc_expr_ast_binaryop osc_expr_ast_arraysubscript osc_expr_ast_unaryop osc_expr_ast_aseq osc_expr_ast_ternarycond osc_expr_ast_let osc_expr_oprec osc_expr_funcrec osc_expr_builtin osc_expr_lexenv osc_expr_keyword

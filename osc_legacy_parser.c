...
#line 27 "osc_legacy_parser.y" /* yacc.c:339  */
...
#line 94 "osc_legacy_parser.y" /* yacc.c:339  */
...
#line 145 "osc_legacy_parser.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "osc_legacy_parser.h".  */
...
#line 63 "osc_legacy_parser.y" /* yacc.c:355  */
...
#line 206 "osc_legacy_parser.c" /* yacc.c:355  */
...
union YYSTYPE
{
#line 147 "osc_legacy_parser.y" /* yacc.c:355  */
...
#line 246 "osc_legacy_parser.c" /* yacc.c:355  */
};
...
#line 276 "osc_legacy_parser.c" /* yacc.c:358  */
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, t_osc_parser_bndl_list **bndl, t_osc_msg_u **msg, void *scanner, long *buflen, char **buf)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, t_osc_parser_bndl_list **bndl, t_osc_msg_u **msg, void *scanner, long *buflen, char **buf)
{
  ...
  YYFPRINTF (yyoutput, ": ");
  yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, bndl, msg, scanner, buflen, buf);
  YYFPRINTF (yyoutput, ")");
}
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 174 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
...
#line 1489 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 3:
#line 185 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("pop MSG %p<-%p\n", *msg, (*msg)->next);
...
#line 1502 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 4:
#line 196 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
...
#line 1515 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 5:
#line 204 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1528 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 6:
#line 212 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1541 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 7:
#line 220 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1555 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 8:
#line 229 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1569 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 9:
#line 238 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1583 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 10:
#line 247 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1597 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 11:
#line 256 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1611 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 12:
#line 265 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1624 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 13:
#line 273 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1637 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 14:
#line 281 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add STRING to MSG %p := %s\n", *msg, (yyvsp[0].string));
		osc_message_u_appendStringPtr(*msg, (yyvsp[0].string));
 	}
#line 1646 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 15:
#line 285 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCADDRESS to MSG %p := %s\n", *msg, (yyvsp[0].string));
		osc_message_u_appendStringPtr(*msg, (yyvsp[0].string));
 	}
#line 1655 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 16:
#line 289 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCFLOAT to MSG %p := %f\n", *msg, (yyvsp[0].f));
		osc_message_u_appendDouble(*msg, (yyvsp[0].f));
 	}
#line 1664 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 17:
#line 293 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCINT32 to MSG %p := %d\n", *msg, (yyvsp[0].i));
		osc_message_u_appendInt32(*msg, (yyvsp[0].i));
 	}
#line 1673 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 18:
#line 297 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCUINT32 to MSG %p := %d\n", *msg, (yyvsp[0].I));
		osc_message_u_appendUInt32(*msg, (yyvsp[0].I));
 	}
#line 1682 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 19:
#line 301 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCINT64 to MSG %p := %d\n", *msg, (yyvsp[0].h));
		osc_message_u_appendInt64(*msg, (yyvsp[0].h));
 	}
#line 1691 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 20:
#line 305 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCUINT64 to MSG %p := %d\n", *msg, (yyvsp[0].H));
		osc_message_u_appendUInt64(*msg, (yyvsp[0].H));
 	}
#line 1700 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 21:
#line 309 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCCHAR to MSG %p := %c\n", *msg, (yyvsp[0].c));
		osc_message_u_appendInt8(*msg, (yyvsp[0].c));
 	}
#line 1709 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 22:
#line 313 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCTIMETAG to MSG %p := %c\n", *msg, (yyvsp[0].b));
		osc_message_u_appendBool(*msg, (int)(yyvsp[0].b));
 	}
#line 1718 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 23:
#line 317 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("add OSCTIMETAG to MSG %p := %llu\n", *msg, (yyvsp[0].t));
		osc_message_u_appendTimetag(*msg, (yyvsp[0].t));
 	}
#line 1727 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 24:
#line 321 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		//if(!(*msg)){
			t_osc_msg_u *m = osc_message_u_alloc();
			PP("push MSG %p->%p\n", m, *msg);
...
#line 1752 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 25:
#line 341 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		//if(!(*msg)){
			t_osc_msg_u *m = osc_message_u_alloc();
			PP("push MSG %p->%p\n", m, *msg);
...
#line 1777 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 26:
#line 361 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		if(!(*msg)){
			t_osc_msg_u *m = osc_message_u_alloc();
			PP("push MSG %p->%p\n", m, *msg);
...
#line 1802 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 27:
#line 381 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		if(!(*msg)){
			t_osc_msg_u *m = osc_message_u_alloc();
			PP("push MSG %p->%p\n", m, *msg);
...
#line 1827 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 28:
#line 404 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		PP("set ADDRESS %p := %s\n", *msg, (yyvsp[-2].string));
		osc_message_u_setAddressPtr(*msg, (yyvsp[-2].string), NULL);
 	}
#line 1836 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;

  case 29:
#line 408 "osc_legacy_parser.y" /* yacc.c:1661  */
    {
		t_osc_msg_u *m = osc_message_u_alloc();
		PP("set ADDRESS %p := %s\n", *msg, (yyvsp[-1].string));
		PP("push MSG %p->%p\n", m, *msg);
...
#line 1850 "osc_legacy_parser.c" /* yacc.c:1661  */
    break;


#line 1854 "osc_legacy_parser.c" /* yacc.c:1661  */
      default: break;
    }
